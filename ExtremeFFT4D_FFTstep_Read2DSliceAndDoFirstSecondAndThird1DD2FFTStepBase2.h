#ifndef ExtremeFFT4D_FFTstep_Read2DSliceAndDoFirstSecondAndThird1DD2FFTStepBase2_included
#define ExtremeFFT4D_FFTstep_Read2DSliceAndDoFirstSecondAndThird1DD2FFTStepBase2_included
...
class ExtremeFFT4D_FFTstep_Read2DSliceAndDoFirstSecondAndThird1DD2FFTStepBase2 : public ExtremeFFT4D_FFTstep {
private:
  Complex* FFTcomplexFactorsForward2;
  Complex* FFTcomplexFactorsBackward2;  
  long int* AddressAuxData1;
  long int* AddressAuxData2;  
  long int* LineNumbers1;
...
public:
  ExtremeFFT4D_FFTstep_Read2DSliceAndDoFirstSecondAndThird1DD2FFTStepBase2(); 
  ~ExtremeFFT4D_FFTstep_Read2DSliceAndDoFirstSecondAndThird1DD2FFTStepBase2(); 
