AnalyzerObservableHiggsGoldstoneUnrotatedTwoParticleK0Correlator::AnalyzerObservableHiggsGoldstoneUnrotatedTwoParticleK0Correlator(FermionMatrixOperations* fOps, AnalyzerIOControl* aIOcon, StateDescriptorReader* SDreader) : AnalyzerObservable(fOps, aIOcon, SDreader, "HiggsGoldstoneUnrotatedTwoParticleK0Correlator", "hgu2pk0corr") { 
  ini(getAnalyzerResultsCount());
}


AnalyzerObservableHiggsGoldstoneUnrotatedTwoParticleK0Correlator::~AnalyzerObservableHiggsGoldstoneUnrotatedTwoParticleK0Correlator() {
}


bool AnalyzerObservableHiggsGoldstoneUnrotatedTwoParticleK0Correlator::analyze(AnalyzerPhiFieldConfiguration* phiFieldConf, Complex** auxVectors) {
...
int AnalyzerObservableHiggsGoldstoneUnrotatedTwoParticleK0Correlator::getNeededAuxVectorCount() {
  return 0;
}


int AnalyzerObservableHiggsGoldstoneUnrotatedTwoParticleK0Correlator::getAnalyzerResultsCount() {
  int LargestL = fermiOps->get1DSizeLargest();
  int L0 = fermiOps->get1DSizeL0();
  int L1 = fermiOps->get1DSizeL1();
  int L2 = fermiOps->get1DSizeL2();
