...
EvaluateObservableMultipleTimeScaleIntegrationTest::EvaluateObservableMultipleTimeScaleIntegrationTest(AnalyzerIOControl* aIOcon, StateDescriptorReader* sdr, EvaluateObservable* obsWeight, EvaluateObservable* obsDetSign, double relStart, double relEnd) : EvaluateObservable(aIOcon, sdr, "MultipleTimeScaleIntegrationTest", "msinttest", relStart, relEnd) { 
...
EvaluateObservableMultipleTimeScaleIntegrationTest::~EvaluateObservableMultipleTimeScaleIntegrationTest() {
}


int EvaluateObservableMultipleTimeScaleIntegrationTest::getAnalyzerResultsCount() {
...
void EvaluateObservableMultipleTimeScaleIntegrationTest::defineObsDependencies() { 
}


bool EvaluateObservableMultipleTimeScaleIntegrationTest::evaluate() {
  trajectoryLength = dataAvail[0][0]*dataAvail[0][2];
  return true;
}


LAPsystemPlot* EvaluateObservableMultipleTimeScaleIntegrationTest::createPlot1(int startInd, int indCount, const char* tag, const char* des) {
...
void EvaluateObservableMultipleTimeScaleIntegrationTest::generateLatexAndPlotsAndXML() {
  if (!MultiplePolynomFlag) {
    ...
    LAPsystemPlot* plot1 = createPlot1(0,8,"MultipleTSouterO2FrogIntegration","Multiple Time Scales with Omelyan O2 as outer Integration");
    LAPsystem->addPlot(plot1);
