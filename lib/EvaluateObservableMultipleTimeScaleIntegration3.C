...
EvaluateObservableMultipleTimeScaleIntegration3::~EvaluateObservableMultipleTimeScaleIntegration3() {
}


int EvaluateObservableMultipleTimeScaleIntegration3::getAnalyzerResultsCount() {
...
void EvaluateObservableMultipleTimeScaleIntegration3::defineObsDependencies() { 
}


bool EvaluateObservableMultipleTimeScaleIntegration3::evaluate() {
  trajectoryLength = dataAvail[0][0]*dataAvail[0][2];
  return true;
}


LAPsystemPlot* EvaluateObservableMultipleTimeScaleIntegration3::createPlot1(int startInd, int indCount, const char* tag, const char* des) {
...
void EvaluateObservableMultipleTimeScaleIntegration3::generateLatexAndPlotsAndXML() {
  if (!MultiplePolynomFlag) {
...
//    LAPsystem->addPlot(plot1);
    LAPsystemPlot* plot2 = createPlot1(0,12,"HiggsMTSOmelyanO2Integration","Omelyan O2 Integration with Higgs force on other time scale");
    LAPsystem->addPlot(plot2);
