...
EvaluateObservableFermionMatrixSingleMFullRanSpectrumNoPreconditioning::~EvaluateObservableFermionMatrixSingleMFullRanSpectrumNoPreconditioning() {
  delete[] Bins;
}


int EvaluateObservableFermionMatrixSingleMFullRanSpectrumNoPreconditioning::getAnalyzerResultsCount() {
  return 16*(L0*L1*L2*L3);
}


void EvaluateObservableFermionMatrixSingleMFullRanSpectrumNoPreconditioning::defineObsDependencies() { 
}


bool EvaluateObservableFermionMatrixSingleMFullRanSpectrumNoPreconditioning::evaluate() {
...
LAPsystemPlot* EvaluateObservableFermionMatrixSingleMFullRanSpectrumNoPreconditioning::createPlot1() {
...
void EvaluateObservableFermionMatrixSingleMFullRanSpectrumNoPreconditioning::generateLatexAndPlotsAndXML() {
