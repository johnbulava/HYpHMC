...
AnalyzerObservableFermionMatrixSingleMFullSpectrumNoPreconditioning::~AnalyzerObservableFermionMatrixSingleMFullSpectrumNoPreconditioning() {
}


bool AnalyzerObservableFermionMatrixSingleMFullSpectrumNoPreconditioning::analyze(AnalyzerPhiFieldConfiguration* phiFieldConf, Complex** auxVectors) {
...
int AnalyzerObservableFermionMatrixSingleMFullSpectrumNoPreconditioning::getNeededAuxVectorCount() {
  return 0;
}


int AnalyzerObservableFermionMatrixSingleMFullSpectrumNoPreconditioning::getAnalyzerResultsCount() {
