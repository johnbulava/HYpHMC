...
EvaluateObservableFermionMatrixSingleMFullNoXiSpectrumNoPreconditioning::EvaluateObservableFermionMatrixSingleMFullNoXiSpectrumNoPreconditioning(AnalyzerIOControl* aIOcon, StateDescriptorReader* sdr, EvaluateObservable* obsWeight, EvaluateObservable* obsDetSign, double relStart, double relEnd) : EvaluateObservable(aIOcon, sdr, "FermionMatrixSingleMFullNoXiSpectrumNoPreconditioning", "specsmfnxnp", relStart, relEnd) { 
  MaxPhaseExtension = 0;
...
EvaluateObservableFermionMatrixSingleMFullNoXiSpectrumNoPreconditioning::~EvaluateObservableFermionMatrixSingleMFullNoXiSpectrumNoPreconditioning() {
  delete[] Bins;
}


int EvaluateObservableFermionMatrixSingleMFullNoXiSpectrumNoPreconditioning::getAnalyzerResultsCount() {
  return 16*(L0*L1*L2*L3);
}


void EvaluateObservableFermionMatrixSingleMFullNoXiSpectrumNoPreconditioning::defineObsDependencies() { 
}


bool EvaluateObservableFermionMatrixSingleMFullNoXiSpectrumNoPreconditioning::evaluate() {
...
LAPsystemPlot* EvaluateObservableFermionMatrixSingleMFullNoXiSpectrumNoPreconditioning::createPlot1() {
...
void EvaluateObservableFermionMatrixSingleMFullNoXiSpectrumNoPreconditioning::generateLatexAndPlotsAndXML() {
